...
object SettingsKeys {
    ...
    val AUTO_DARK_MODE = booleanPreferencesKey("auto_dark_mode") // Novo
}
...
class SettingsRepository(private val context: Context) {
    ...
    val autoDarkModeFlow: Flow<Boolean> = context.settingsDataStore.data
        .map { it[SettingsKeys.AUTO_DARK_MODE] ?: true } // Novo: padrão ativo
    ...
    suspend fun setAutoDarkMode(enabled: Boolean) { // Novo
        context.settingsDataStore.edit { it[SettingsKeys.AUTO_DARK_MODE] = enabled }
    }
}
